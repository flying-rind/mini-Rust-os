...
static IDT: Lazy<InterruptDescriptorTable> = Lazy::new(|| {
    ...
    // idt[0x80 as usize].set_handler_fn(crate::syscall::system_call);
...
extern "x86-interrupt" fn mouse_interrupt_handler(_stack_frame: InterruptStackFrame) {
    ...
    crate::task::mouse::add_package(package);
    notify_eoi(InterruptIndex::Mouse as u8);
}

// extern "x86-interrupt" fn interrupt_0_handler(_stack_frame: InterruptStackFrame) {
//     serial_println!("[int 0x80] I was called.");
//     fb_println!("[int 0x80] I was called.");
//     notify_eoi(0x80 as u8);
// }
