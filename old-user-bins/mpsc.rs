...
use alloc::vec::Vec;
use user_lib::{
    exit, print, println, semaphore_create, semaphore_down, semaphore_up, thread_create, waittid,
};

const SEM_MUTEX: usize = 0;
const SEM_EMPTY: usize = 1;
const SEM_FULL: usize = 2;
...
pub fn main() -> i32 {
    ...
    assert_eq!(semaphore_create(0) as usize, SEM_FULL);
    ...
    for i in 0..PRODUCER_COUNT {
        threads.push(thread_create(
            producer as usize,
            &ids.as_slice()[i] as *const usize as usize,
        ));
    }
