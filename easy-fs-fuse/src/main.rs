...
fn efs_test() -> std::io::Result<()> {
    ...
    // debug
    println!("random_str_test1 passed!");

    random_str_test(8 * BLOCK_SIZE + BLOCK_SIZE / 2);
    println!("random_str_test2 passed!");

    random_str_test(100 * BLOCK_SIZE);
    println!("random_str_test3 passed!");

    random_str_test(70 * BLOCK_SIZE + BLOCK_SIZE / 7);
    println!("random_str_test4 passed!");

    random_str_test((12 + 128) * BLOCK_SIZE);
    println!("random_str_test5 passed!");

    // random_str_test(400 * BLOCK_SIZE);
    println!("random_str_test6 passed!");

    random_str_test(1000 * BLOCK_SIZE);
    println!("random_str_test7 passed!");

    random_str_test(2000 * BLOCK_SIZE);
    println!("random_str_test8 passed!");
